        ...
        <>
            <section>
                <div className="container">
                    <div className="sm:pt-20 pt-10 sm:pb-10">
                        <div className="flex flex-col gap-10 ">
                            <div className="sm:flex flex-col hidden  border-b pb-5 gap-[10px]">
                            ...
                            <div className="sm:flex grid gap-6 ">
                                <div className="flex justify-between sm:hidden items-start">
                                    <div className="flex flex-col sm:max-w-[466px] max-w-[375px] w-full sm:gap-[10px]">
                                        <h4 className='sm:text-2xl text-xl leading-[160px] tracking-[0.15px] font-heebo_Medium text-gray-graystrong'>Apple watch SE </h4>
                                        <p className="Copytext">Price: $600.00 <span className='SameText'>- Silver Aluminium Case with Abyss Blue Sport Band - Regular</span></p>
                                    </div>
                                    <img src={ExitIcon} alt="ExitIcon" />
                                </div>
                                <div className="flex flex-col sm:gap-5 gap-[14px]">
                                    <div className="relative sm:p-[50px] p-[30px] sm:pb-[70px] pb-10 bg-[#ED5F600A] rounded-[20px]">
                                        <img className='rounded-[20px]' src={WatchDetail} alt="WatchDetail" />
                                        <img className='absolute border-[#495F6A2E] border p-[10px] sm:top-[30px] top-[15px] sm:right-[30px] right-[15px] rounded-full' src={Heart} alt="Heart" />
                                        <div className="flex gap-2 sm:bottom-5 bottom-[10px]  absolute">
                                ...
                                <div className="flex flex-col sm:gap-[30px] gap-[14px] max-w-[564px] w-full">
                                    <div className="sm:flex justify-between hidden items-start">
                                    ...
                                    <div className="flex flex-col gap-[10px]">
                                        <div className="flex border-[#42265914] border rounded-[10px] px-5 py-[10px] justify-between">
                                            <div className="flex flex-col gap-[5px]">
                                                <h4 className='CommonHead'>$320.00</h4>
