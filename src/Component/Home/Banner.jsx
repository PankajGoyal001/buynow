  ...
  return (
    ...
    {/* <div className="bg-[url('src/assets/Images/background.png')] w-full bg-cover"> */}
      <div className="container">
        <div className=" justify-between md:flex-row flex flex-col items-center md:mt-20 mt-[30px] pb-[50px] md:pb-[65px]">
          <div className="grid md:gap-10 gap-[30px] font-heebo_Medium">
            <div className="grid gap-5 max-w-[490px] ">
              <div className="flex items-center ">
                <h3 className=" text-[#422659] text-base font-inter_Medium md:font-heebo_Medium md:text-xl leading-8">
                  Top Collections{" "}
                </h3>
                <img className="md:w-6 w-5" src={Fire} alt="fire" />
              </div>
              <h1 className="md:text-[60px] text-[34px] leading-[42px] tracking-wide md:tracking-tighter md:leading-[72px] ">Best Place To Find And<span className=" text-[#67517A] "> Buy Products</span>For Your Need</h1>
            </div>
            <div className="md:pt-10 pt-[30px] tracking-[0.17px] md:tracking-[0.15px] grid gap-[30px] md:gap-10 border-t-2 ">
              <p className="text-gray-graystrong font-inter_regular text-sm md:text-base">
                For first pruches{" "}
                <span className="leading-8 text-xl text-yellow-yellow font-inter_Medium">
                  Get 30% off{" "}
                </span>
              </p>
