              ...
              Branded.map((items, index) => (
                <div key={index} className="flex flex-col p-10 border rounded-[20px] gap-5">
                  <div className="flex flex-col items-center gap-[10px]">
                    <h4 className="text-gray-graystrong font-heebo_Medium text-xl leading-8 tracking-[0.15px]">{items.Name}</h4>
                    ...
                    <div className="flex px-2 hover:cursor-pointer py-[6px] gap-[10px]">
                      <p className="text-purple-Purple_dark text-sm leading-6 tracking-[0.4px]">{items.buy}</p>
