    ...
    <>
     <div className="container md:py-10 py-[25px]">
      ...
      <div className="flex flex-col gap-5">
        <div className="">
          <h2 className="font-heebo_Medium md:text-[34px] text-2xl md:leading-[42px] text-gray-graystrong tracking-wide" >Top Collection</h2>
        </div>
        <div className="flex gap-[10px] overflow-scroll [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none'] border-b"> 
        {
          Collection.map((items,index)=>(
            <div key={index + Date.now() + items}>
              <Link to={items}>
              <p className=" px-2 py-3 hover:border-b-2 text-nowrap border-purple-Purple_dark text-gray-graydark hover:text-purple-Purple_dark font-inter_regular text-sm leading-6 tracking-[0.4px]">{items.Title}</p></Link>
            </div>
          ))
        }
      ...
      <div className="md:flex grid gap-[10px] md:gap-6">
        {
