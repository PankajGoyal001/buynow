      ...
      <div className="container">
        <div className=" md:py-10 py-[25px]">
          <div className="flex flex-col gap-5 sm:gap-10">
            <div className="flex border-b  overflow-scroll [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none'] gap-[10px]">
              <p className="px-2 py-3 text-nowrap font-inter_regular text-sm leading-[100%] tracking-[0.5px] hover:text-purple-Purple_dark text-gray-graydark hover:border-b-2 hover:border-purple-Purple_dark">TODAY OFFERS</p>
              <p className="px-2 py-3 text-nowrap font-inter_regular text-sm leading-[100%] tracking-[0.5px] hover:text-purple-Purple_dark text-gray-graydark hover:border-b-2 hover:border-purple-Purple_dark">MONTHLY OFFERS</p>
              <p className="px-2 py-3 text-nowrap font-inter_regular text-sm leading-[100%] tracking-[0.5px] hover:text-purple-Purple_dark text-gray-graydark hover:border-b-2 hover:border-purple-Purple_dark">COMMING SOON</p>
            </div>
