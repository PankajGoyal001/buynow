      ...
      <div className="container md:py-10 py-[25px]">
        <div className="flex flex-col overflow-scroll gap-10">
          <div className="flex border-b gap-[10px]">
            ...
            <p className="px-2 py-3 font-inter_regular text-sm leading-6 tracking-[0.5px] hover:text-purple-Purple_dark text-gray-graydark hover:border-b-2 hover:border-purple-Purple_dark">COMMING SOON</p>
          </div>
                ...
                <div key={index} className="flex lg:w-[368px] w-[249px]   bg-[url('src/assets/Images/offerbackground.png')] rounded-[20px] justify-between items-center">
                  <div className="flex flex-col pt-[30px] pl-[30px] pb-[42px] w-[212px] z-10 gap-5">
                    <div className="flex flex-col gap-[10px]">
                      <p className="font-heebo_Medium text-[34px] leading-[42px] tracking-wide text-gray-graystrong">{items.Discount}</p>
                      <p className="font-heebo_Medium  text-gray-graystrong tracking-[0.15px] text-xl leading-8">{items.Price}</p>
                    </div>
                  <p className="tracking-[0.15px] text-sm leading-6 text-gray-graydark">{items.Name}</p>
                  </div>
