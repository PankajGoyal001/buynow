                        ...
                        <div className="sm:flex-row flex flex-col gap-5 justify-between items-start">
                            <div className="flex gap-[5px]">
                                ...
                                <div className="flex sm:max-w-[343px] w-full flex-col">
                                    ...
                                    <div className="flex pb-[3.74px] sm:mt-[32.75px] mt-[21] gap-2">
                                        <p className="text-base tracking-[0.15px]  font-inter_regular text-gray-graydark">Ordered conformed</p>
                                        <p className="SameText">(12/08/2022)</p>
                                    </div>
                                    <p className="sm:text-sm text-xs leading-[166%] tracking-[0.4px] sm:tracking-[0.17px] font-inter_regular text-gray-graydark pt-[10px] border-t">Lorem ipsum dolor sit amet, consectetr adipiscing elit.</p>
                                    <div className="flex pb-[3.74px] sm:mt-[52.75px] mt-[41px] gap-2">
                                        <p className="text-base tracking-[0.15px] font-inter_regular text-gray-graydark">Ordered conformed</p>
                                        <p className="SameText">(12/08/2022)</p>
                                    </div>
                                    <p className="sm:text-sm text-xs leading-[166%] tracking-[0.4px] sm:tracking-[0.17px] font-inter_regular text-gray-graydark pt-[10px] border-t">Pulvinar quis condimentum vel lectus sit eu.</p>
                                    <div className="flex pb-[3.74px] sm:mt-[72.75px]  mt-[41px]  gap-2">
                                        <p className="text-base tracking-[0.15px] font-inter_regular text-[#2E7D32]">Ordered conformed</p>
                                        <p className="SameText">(12/08/2022)</p>
                                    </div>
                                    <p className="sm:text-sm text-xs leading-[166%] tracking-[0.4px] sm:tracking-[0.17px] font-inter_regular text-gray-graydark pt-[10px] border-t">Accumsan tristique dui tincidunt tristique. Dignissim lectus mollis.</p>
                                </div>
                            </div>
