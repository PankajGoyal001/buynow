      ...
      <div className="sm:py-20 py-10">
        <div className="container">
          <div className="flex flex-col gap-5 sm:gap-10">
            ...
            <div className="flex flex-col gap-[13px] p-[15px] sm:p-[30px] pb-[13px] sm:pb-[23px] bg-[#FAFAFA] rounded-[20px]">
              <div className="flex justify-between">
                <p className="SameText hover:text-purple-Purple_dark hover:cursor-pointer ">Delivery Address</p>
                <Link to={"/order"}>
                  <p className="SameText hover:text-purple-Purple_dark hover:cursor-pointer text-end">Order Summary</p>
                </Link>
                <Link to={"/payment"}>
                  <p className="SameText hover:text-purple-Purple_dark hover:cursor-pointer text-end">Payment Option</p>
                </Link>
                <Link to={"/complete"}>
            ...
            <div className="md:flex grid gap-6 items-start">
              <div className="flex flex-col max-w-[760px] w-full gap-[10px] sm:gap-5">
                ...
                <div className="flex flex-col max-w-[760px] w-full gap-5">
                  <h5 className='Copytext'>New Address</h5>
                  ...
                  <div className="flex gap-6">
                    <Buttons variant={"Simple"} classname={"border"} href={""} childname={"Save Address"} />
                    <Link to={"/selectdeleviry"}>
                      <button className='px-[11px] py-2 text-[15px] leading-[173%] tracking-[0.46px] font-inter_Medium text-purple-Purple_dark'>CANCEL</button>
                    </Link>
                  </div>
                </div>
              </div>
